...
echo "    ./episode_splitter.sh -p=\"/tvshows/show name/\""
echo ""
echo "    Split a single episode:"
echo "    ./episode_splitter.sh -p=\"/tvshows/show name/show name.ext\""
echo ""
echo "    Split a single episode:"
echo "    ./episode_splitter.sh -p=\"/tvshows/show name/show name.ext\""
echo ""
...
echo "    ./episode_splitter.sh -p=\"/tvshows/show name/\" --index"
echo ""
...
echo "    ./episode_splitter.sh -p=\"/tvshows/show name/\" -b=0.2"
echo ""
echo "    Override the black length. check ffmpeg documention"
echo "    ./episode_splitter.sh -p=\"/tvshows/show name/\" -l=0.3"
fi
